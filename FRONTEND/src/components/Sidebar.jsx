            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.aside
                        ...
                        className="fixed left-0 top-0 min-h-screen h-full w-64 glass-card border-r border-border/50 p-6 z-40 md:relative md:sticky md:top-0 md:self-start md:h-screen"
                    >
